...
function CompanyPage({ match } : any) {
    ...
    <Switch>
        <Route path={`${match.path}/allCoupons`} exact component={AllCompanyCoupons} />
        <Route path={`${match.path}/newCoupon`} exact component={AddCoupon} />
        <Route path={`${match.path}/updateCoupon`} exact component={UpdateCoupon} />
        <Route path={`${match.path}/companyDetails`} exact component={CompanyDetails} />
    </Switch>
</>;
}
