...
//<Route path={`${match.path}/`} exact component={AdminMenu} />
...
function AdminPage({ match } : any) {
    ...
    <h1>Hello Administrator, please choose from the options above</h1>
        ...
        <Switch>
            <Route path={`${match.path}/allCompanies`} exact component={AllCompanies} />
            <Route path={`${match.path}/allCustomers`} exact component={AllCustomers} />
            <Route path={`${match.path}/oneCompany`} exact component={OneCompany} />
            <Route path={`${match.path}/oneCustomer`} exact component={OneCustomer} />
            <Route path={`${match.path}/companyCoupons`} exact component={CompanyCoupons} />
            <Route path={`${match.path}/customerCoupons`} exact component={CustomerCoupons} />
            <Route path={`${match.path}/newCompany`} exact component={AddCompany} />
            <Route path={`${match.path}/newCustomer`} exact component={AddCustomer} />
            <Route path={`${match.path}/updateCompany`} exact component={UpdateCompany} />
            <Route path={`${match.path}/updateCustomer`} exact component={UpdateCustomer} />
